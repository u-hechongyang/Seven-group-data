...
cities = ['shushanqu','baohequ','luyangqu','yaohaiqu','beicheng','feixi','feidong','chaohushi','lujiangs']
...
def get_url(city):
    ...
    # 城市值为None时，我们就跳出
        ...
        url = 'https://www.anjuke.com/fangjia/hf2019/{city}/'.format(city=city)
        return url
...
def get_ressponse(url,file,headers):
    ...
    try:
        ...
        #print(line)
        #print(line)
        result = re.findall('<a href="http://www.anjuke.com/fangjia/hf2019/(.*?)/">',line,re.S)
        #for i in range(100):
        print(result)
...
def main(city):
    try:
        headers = {
            ...
            'Referer': 'https://www.anjuke.com/fangjia/hf2019/{city}/'.format(city=city),
            'Host': 'www.anjuke.com',
        }
...
if __name__ == '__main__':
    with open('D:/testdata1/anhui.csv', 'w', encoding='utf-8') as f:
        writer = csv.writer(f)
        for x in range(0,50):
            city = get_city()
            time.sleep(10)
