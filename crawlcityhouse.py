...
cities = ['nanjing','wuxi','xuzhou','cz','suzhou','nantong','lianyungang','huaian','yancheng','yangzhou','zhenjiang','suqian','taizhou']
# 一个我们将要爬取城市的列表
...
def get_url(index,city):
    ...
    # 城市值为None时，我们就跳出
        ...
        url = 'https://www.anjuke.com/fangjia/{city}{index}/'.format(index=index,city=city)
        return url
    ...
    for index in range(2010, 2020):
        try:
            headers = {
                ...
                'Referer': 'https://www.anjuke.com/fangjia/{city}{index}/'.format(index=index,city=city),
...
if __name__ == '__main__':
    with open('D:/testdata/jiangsu.csv','a',encoding='utf-8') as f:
